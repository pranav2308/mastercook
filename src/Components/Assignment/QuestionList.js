     ...
     <div class = "questionsContainer">
        <form>
          <div class="form-group question-answer">
            <label id = "question-1" className = "question-text">Question 1. What is the main ingredient to make a rice bowl?   (2 Marks)</label>
          ...
          <div class="form-group  question-answer">
            <label id = "question-2" className = "question-text">Question 2. What is the colour of turmeric?  (2 Marks)</label>
          ...
          <div class="form-group question-answer">
            <label id = "question-3" className = "question-text">Question 3. Which of the following elements cannot be added in pasta?  (2 Marks)</label>
          ...
          <div class="form-group  question-answer">
            <label id = "question-4" className = "question-text">Question 4. Which tool is used to cut vegetables?  (2 Marks)</label>
          ...
          <div class="form-group  question-answer">
            <label  id = "question-5" className = "question-text">Question 5. What do julienne cuts look like?  (2 Marks)</label>
          ...
          <div class="form-group question-answer">
            <label id = "question-6" className = "question-text">Question 6. When you cook your pasta al dente, what should the texture be?  (2 Marks)</label>
          ...
          <div class="form-group question-answer">
            <label id = "question-7" className = "question-text">Question 7. Foods that are poached are cooked with what?  (2 Marks)</label>
          ...
          <div class="form-group question-answer">
            <label id = "question-8" className = "question-text">Question 8. What is the name of a person who makes sauces in a professional kitchen?  (2 Marks)</label>
          ...
          <div class="form-group  question-answer">
            <label id = "question-9" className = "question-text">Question 9. Which of the following is an ingredient found in many Indian dishes?  (2 Marks)</label>
          ...
          <div class="form-group question-answer">
            <label id = "question-10" className = "question-text">Question 10. Whipping egg whites will result in what?  (2 Marks)</label>
